...
$separate_meta = esc_html_x( ', ', 'Tags list separator.', 'bjork' );
...
<span class="entry-meta-item tags-links">
	...
	<span class="entry-meta-description"><?php echo esc_html_x( 'Tagged as:', 'Post meta info description: tags list.', 'bjork' ); ?></span>
