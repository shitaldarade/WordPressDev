...
<!-- wp:html -->
<form>
<p style="width: 48%; float: left;"><label for="field1"><?php echo esc_html_x( 'Your name', 'Theme starter content', 'bjork' ); ?></label><input id="field1" style="width: 100%;" type="text"></p>
<p style="width: 48%; float: right;"><label for="field2"><?php echo esc_html_x( 'Your email', 'Theme starter content', 'bjork' ); ?></label><input id="field2" style="width: 100%;" type="email"></p>
<p style="clear: both;"><label for="field3"><?php echo esc_html_x( 'Your message', 'Theme starter content', 'bjork' ); ?></label><textarea id="field3" style="width: 100%;" rows="2"></textarea></p>
<p><small><strong><?php echo esc_html_x( 'This is only a dummy form placeholder. Use a plugin to add forms to your website.', 'Theme starter content', 'bjork' ); ?></strong></small></p>
