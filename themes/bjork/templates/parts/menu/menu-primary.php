...
<nav id="site-navigation" class="main-navigation" aria-label="<?php echo esc_attr_x( 'Main menu', 'Navigational menu.', 'bjork' ); ?>">
	...
	if ( $is_mobile_nav_enabled ) :
		...
		>
			...
			<span class="screen-reader-text"><?php echo esc_html_x( 'Menu', 'Mobile navigation toggle button title.', 'bjork' ); ?></span>
		</button>
		<?php
	endif;
