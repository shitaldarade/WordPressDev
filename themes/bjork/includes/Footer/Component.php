...
class Component implements Component_Interface {
	...
	public static function init() {
		...
		// Processing
			...
			// Filters
				...
				add_filter( 'pre/bjork/accessibility/link_skip_to', __CLASS__ . '::skip_links_no_footer', 10, 2 );
	...
	public static function is_disabled(): bool {
		...
		// Output
			 ...
			 */
			return (bool) apply_filters( 'bjork/footer/is_disabled', false );
	...
	public static function is_enabled(): bool {
		...
		// Output
			 ...
			 */
			return (bool) apply_filters( 'bjork/footer/is_enabled', ! self::is_disabled() );
	...
	public static function skip_links_no_footer( $pre, string $id ) {
		...
		// Processing
			...
			if (
				 ...
				 */
				(bool) apply_filters( 'bjork/skip_links_no_footer', self::is_disabled() )
