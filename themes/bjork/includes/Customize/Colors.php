...
class Colors implements Component_Interface {
	 ...
	 * @var     string
	 */
	public static $transient_cache_colors = 'bjork_cache_theme_colors';
	...
	public static function init() {
		...
		// Processing
			...
			// Filters
				...
				add_filter( 'bjork/customize/options/get', __CLASS__ . '::options', 15 );
	...
	public static function options( array $options ): array {
		...
		// Variables
			 ...
			 */
			$editor_palette = array_values( (array) apply_filters( 'bjork/customize/colors/editor_palette', self::$editor_palette ) );


		// Processing

			$options[ 100 . 'colors' . 110 ]['palette'] = array( 'name' => esc_html__( 'Accent color', 'bjork' ) );
			$options[ 100 . 'colors' . 120 ]['palette'] = array( 'name' => esc_html__( 'Accent text color', 'bjork' ) );
			...
			$options[ 190 . 'colors' ] = array(
				...
				'create_section' => sprintf(
					...
					esc_html_x( 'Editor palette', 'Customizer color section title', 'bjork' )
				),
			...
			$options[ 190 . 'colors' . 100 ] = array(
				'type'    => 'html',
				'content' => '<p>' . esc_html__( 'Accent color is also being conveniently added into editor color palette for you, so you don\'t need to duplicate it here.', 'bjork' ) . '</p>',
			);
			...
			foreach ( $editor_palette as $key => $color ) {
				...
				$options[ 190 . 'colors' . ( 100 + $key * 10 ) ] = array(
					...
					'label'      => sprintf(
						...
						esc_html__( 'Palette color %d', 'bjork' ),
						$key
					),
