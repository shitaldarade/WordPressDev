...
class CSS_Variables implements Component_Interface {
	 ...
	 * @var     string
	 */
	public static $transient_cache_key = 'bjork_css_vars';
	...
	public static function init() {
		...
		// Processing
			...
			// Actions
				...
				add_action( 'bjork/upgrade', __CLASS__ . '::transient_cache_flush' );
	...
	public static function get_array(): array {
		...
		// Requirements check
			...
			if (
				...
				return (array) apply_filters( 'bjork/customize/css_variables/get_array', $css_vars );
			}
		...
		// Processing
			...
			foreach ( (array) Options::get() as $option ) {
				 ...
				 */
				$css_vars = apply_filters( 'bjork/customize/css_variables/get_array/partial', $css_vars, $option, $value );
			}
	...
	public static function get_string( string $separator = ' ' ): string {
		...
		// Output
			 ...
			 */
			return (string) apply_filters( 'bjork/customize/css_variables/get_string', trim( (string) $css_vars ) );
			...
			wp_add_inline_script(
				...
				Assets\Factory::strip( "
					( function() {
						...
						window.onresize = function() { bjorkScrollbarWidth() };
					} )();
				" )
			);
