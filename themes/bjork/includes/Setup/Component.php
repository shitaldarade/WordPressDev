...
class Component implements Component_Interface {
	...
	public static function after_setup_theme() {
		...
		// Processing
			...
			load_theme_textdomain( 'bjork', get_template_directory() . '/languages' );
			...
			// Required for site title hiding.
	...
	public static function content_width() {
		...
		// Processing
			...
			/**
			 * We cannot use WebManDesign\Bjork\Customize\Mod::get() here as we are setting
			...
			$GLOBALS['content_width'] = absint(
				 ...
				 */
				apply_filters( 'bjork/setup/content_width', $content_width )
			);
