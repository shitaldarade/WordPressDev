...
namespace WebManDesign\Bjork\Content;
...
class Component implements Component_Interface {
	...
	public static function get_content_type( string $context = '' ): string {
		...
		// Output
			 ...
			 */
			return (string) apply_filters( 'bjork/content/get_content_type', get_post_type(), $context, $sub_context );
	...
	public static function get_paged_info(): string {
		...
		// Pre
			...
			/**
			 * Bypass filter for WebManDesign\Bjork\Content\Component::get_paged_info().
			 *
			 ...
			 */
			$pre = apply_filters( 'pre/bjork/content/get_paged_info', false );
	...
	public static function show_primary_title(): bool {
		...
		// Output
			 ...
			 */
			return (bool) apply_filters( 'bjork/content/show_primary_title', true );
