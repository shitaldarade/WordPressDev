...
class Blocks implements Component_Interface {
	...
	public static function render_block( string $block_content, array $block ): string {
		...
		// Variables
			 ...
			 * @param  array  $block
			 */
			$defaults = apply_filters( 'bjork/content/blocks/render_block/defaults', array(
		...
		// Processing
			...
			if (
				...
				$class = ( false !== strpos( $attrs['className'], 'has-decoration' ) ) ? ( 'alignwide-wrap has-decoration-container' ) : ( 'alignwide-wrap' );
				$atts = array(
