...
class Factory {
	...
	public static function set_asset_args( array $args = array() ): array {
		...
		// Variables
			 ...
			 * @param  array $args
			 */
			$args = (array) apply_filters( 'bjork/assets/set_asset_args', $args );
	...
	public static function preloading_styles_enabled(): bool {
		...
		// Output
			 ...
			 */
			return (bool) apply_filters( 'bjork/assets/preloading_styles_enabled', ! AMP::is_amp() );
	...
	public static function esc_css( string $css = '', string $context = '' ): string {
		...
		// Output
			 ...
			 */
			return (string) apply_filters( 'bjork/assets/esc_css', (string) $css, (string) $context );
